...
/// @brief tests for basic_matrix class
/// @author acekype992
///
...
void tst_fill() __ack__START_TEST
    ...
    ack::basic_matrix<char, 10, 7> mat;
    char letter {'K'};
    mat.fill(letter);
...
///////////////////////////////
// only basic_numeric_matrix //
///////////////////////////////
void tst_addition() __ack__START_TEST

    ack::basic_numeric_matrix<int, 3, 4> mat_1;
    ...
    ack::basic_numeric_matrix<int, 3, 4> mat_2;
    ...
    ack::basic_matrix<int, 3, 4> mat_result;
    ...
    const ack::basic_matrix<int, 3, 4> mat = mat_1 + mat_2;
    for(std::size_t y {0}; y < mat.rows; ++y)
        for(std::size_t x {0}; x < mat.columns; ++x)
...
void tst_get_vector_row() __ack__START_TEST
    ...
    ack::basic_numeric_matrix<int, 3, 1> row_vector_result;
